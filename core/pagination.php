...
class Zebra_Pagination
{
    ...
    private function _show_pages()
    {
        ...
        // if the total number of pages is greater than the number of selectable pages
            ...
            $output .= '<li '.
            ($this->_properties['page'] == ($this->_properties['reverse'] ? $this->_properties['total_pages'] : 1) ? 'class="active"' : '').' ><a href="' . $this->_build_uri($this->_properties['reverse'] ? $this->_properties['total_pages'] : 1) . '" ' .
            ...
            $output .= '<li '.
            ($this->_properties['page'] == $i ? 'class="active"' : '')
            .'><a href="' . $this->_build_uri($this->_properties['reverse'] ? 1 : $this->_properties['total_pages']) . '" ' .
